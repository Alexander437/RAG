...
from backend.rag.schemas import DataPointVector, VectorDBConfig
...
class QdrantVectorDB(BaseVectorDB):
    ...
    def _get_records_to_be_upserted(self,
                                    collection_name: str,
    ...
    def list_documents_in_collection(self,
                                     collection_name: str,
                                     base_document_id: str = None) -> List[str]:
        """
        Список со всеми документами в коллекции
        """
        logger.debug(
    ...
    def list_document_vector_points(self, collection_name: str) -> List[DataPointVector]:
        """
        Список всех векторов в коллекции
        """
        logger.debug(
