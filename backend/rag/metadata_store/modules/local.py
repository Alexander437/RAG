...
from backend.rag.metadata_store.base import BaseMetadataStore, get_data_source_fqn
...
class LocalMetadataStore(BaseMetadataStore):
    ...
    def __init__(self, config: dict):
        ...
        # Возможно, сделать здесь для list
    ...
    def unassociate_data_source_with_collection(self,
                                                collection_name: str,
                                                data_source_fqn: str) -> Collection:
        return self.collection

    def create_data_ingestion_run(self,
                                  data_ingestion_run: CreateDataIngestionRun) -> DataIngestionRun:
        random_name = "".join(
    ...
    def get_data_ingestion_run(self,
                               ...
                               no_cache: bool = False) -> DataIngestionRun | None:
        return next(
            (
                data_ingestion_run
    ...
    def get_data_ingestion_runs(self,
                                collection_name: str,
                                data_source_fqn: str = None) -> List[DataIngestionRun]:
