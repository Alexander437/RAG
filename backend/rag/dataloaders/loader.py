...
from backend.rag.schemas import DataIngestionMode, DataSource, LoadedDataPoint, ComponentDto
...
def list_dataloaders() -> List[ComponentDto]:
    """
    Возвращает список всех зарегистрированных загрузчиков
    Returns:
        List[ComponentDto]: Список всех зарегистрированных загрузчиков
    """
    global LOADER_REGISTRY
    return [
        ComponentDto(type=loader_type, class_=cls.__name__, description=cls.__doc__.strip())
