...
class EmbedderConfig(BaseModel):
    ...
    config: Optional[Dict[str, Any]] = Field(
        title="Configuration for the embedder", default=None,  # default={"model_name": "path_to_model"}
    )
...
class LLMConfig(BaseModel):
    ...
    provider: Literal["gigachat", "ollama"] = Field(
        title="Model provider any one between gigachat or ollama",
        default="ollama",
    )
